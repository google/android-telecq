...
def lsb_addr_to_bd_addr(lsb_address: str) -> str:
  ...
  The BES board logs Bluetooth address information in LSB order without colons,
  this method converts the format to Bluetooth Device Address (BD_ADDR) format.
