...
def install_and_load_telecom_snippet(
  ...
  """
  if (
      not "android_telecq/snippet/telecom_snippets.apk"
      or not snippet_package
  ):
    raise ValueError('Either user_params or snippet_package must be provided.')
  apk_utils.install(ad, "android_telecq/snippet/telecom_snippets.apk")
...
def install_and_load_bluetooth_snippet(
  ...
  """
  if (
      not "android_telecq/bluetooth/snippet/bluetooth_snippets.apk"
      or not snippet_package
  ):
    raise ValueError('Either user_params or snippet_package must be provided.')
  apk_utils.install(ad, "android_telecq/bluetooth/snippet/bluetooth_snippets.apk")
  ad.load_snippet(snippet_name, snippet_package)
